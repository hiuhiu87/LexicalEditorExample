...
export default function BeautifulMentionComponent(props) {
    ...
    if (Component) {
        return (_jsx(Component, { ref: ref, trigger: trigger, value: value, data: data, className: composedClassNames, "data-beautiful-mention": mention, children: mention }));
    }
    if (classNames) {
        return (_jsxs("span", { ref: ref, className: isSelected && !!classNames.containerFocused
                ? classNames.containerFocused
                : classNames.container, "data-beautiful-mention": mention, children: [_jsx("span", { className: classNames.trigger, children: trigger }), _jsx("span", { className: classNames.value, children: value })] }));
    }
