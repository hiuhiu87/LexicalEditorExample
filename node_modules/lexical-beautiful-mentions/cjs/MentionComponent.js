...
function BeautifulMentionComponent(props) {
    ...
    if (Component) {
        return ((0, jsx_runtime_1.jsx)(Component, { ref: ref, trigger: trigger, value: value, data: data, className: composedClassNames, "data-beautiful-mention": mention, children: mention }));
    }
    if (classNames) {
